...
Version  : 23.04.3
Release  : 33
URL      : https://download.kde.org/stable/release-service/23.04.3/src/rocs-23.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.3/src/rocs-23.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.3/src/rocs-23.04.3.tar.xz.sig
...
%prep
%setup -q -n rocs-23.04.3
cd %{_builddir}/rocs-23.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688834232
mkdir -p clr-build
pushd clr-build
