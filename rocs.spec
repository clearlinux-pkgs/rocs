...
Version  : 22.12.3
Release  : 28
URL      : https://download.kde.org/stable/release-service/22.12.3/src/rocs-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/rocs-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/rocs-22.12.3.tar.xz.sig
...
%prep
%setup -q -n rocs-22.12.3
cd %{_builddir}/rocs-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677774448
mkdir -p clr-build
pushd clr-build
