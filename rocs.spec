...
Source0  : https://download.kde.org/stable/release-service/20.12.0/src/rocs-20.12.0.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : EPL-1.0 GFDL-1.2 LGPL-2.1
...
%prep
%setup -q -n rocs-20.12.0
cd %{_builddir}/rocs-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607734429
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/rocs-20.12.0/COPYING.2.LIB.LGPL-2.1 %{buildroot}/usr/share/package-licenses/rocs/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/rocs-20.12.0/COPYING.3.DOC %{buildroot}/usr/share/package-licenses/rocs/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/rocs-20.12.0/libgraphtheory/fileformats/dot/autotests/testfiles/COPYING.TESTDATA.EPL-1 %{buildroot}/usr/share/package-licenses/rocs/3348e5430ba4fb49fa8eb6e9caf4f06266639d0d
pushd clr-build
%make_install
popd
