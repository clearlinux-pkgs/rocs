...
Source0  : https://download.kde.org/stable/release-service/20.12.1/src/rocs-20.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.1/src/rocs-20.12.1.tar.xz.sig
...
%prep
%setup -q -n rocs-20.12.1
cd %{_builddir}/rocs-20.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610063918
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/rocs-20.12.1/COPYING.1.GPL2 %{buildroot}/usr/share/package-licenses/rocs/0c10177c981f7c8d708265e640bd604777a5d38b
cp %{_builddir}/rocs-20.12.1/COPYING.2.LIB.LGPL-2.1 %{buildroot}/usr/share/package-licenses/rocs/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/rocs-20.12.1/COPYING.3.DOC %{buildroot}/usr/share/package-licenses/rocs/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/rocs-20.12.1/libgraphtheory/fileformats/dot/autotests/testfiles/COPYING.TESTDATA.EPL-1 %{buildroot}/usr/share/package-licenses/rocs/3348e5430ba4fb49fa8eb6e9caf4f06266639d0d
pushd clr-build
%make_install
popd
