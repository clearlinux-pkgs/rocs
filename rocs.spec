...
Version  : 20.08.3
Release  : 2
URL      : https://download.kde.org/stable/release-service/20.08.3/src/rocs-20.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/rocs-20.08.3.tar.xz
...
%prep
%setup -q -n rocs-20.08.3
cd %{_builddir}/rocs-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604627319
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/rocs-20.08.3/COPYING.2.LIB.LGPL-2.1 %{buildroot}/usr/share/package-licenses/rocs/9a1929f4700d2407c70b507b3b2aaf6226a9543c
cp %{_builddir}/rocs-20.08.3/COPYING.3.DOC %{buildroot}/usr/share/package-licenses/rocs/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/rocs-20.08.3/libgraphtheory/fileformats/dot/autotests/testfiles/COPYING.TESTDATA.EPL-1 %{buildroot}/usr/share/package-licenses/rocs/3348e5430ba4fb49fa8eb6e9caf4f06266639d0d
pushd clr-build
%make_install
popd
