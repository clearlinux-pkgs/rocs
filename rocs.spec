...
Version  : 23.04.2
Release  : 32
URL      : https://download.kde.org/stable/release-service/23.04.2/src/rocs-23.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/rocs-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/rocs-23.04.2.tar.xz.sig
...
%prep
%setup -q -n rocs-23.04.2
cd %{_builddir}/rocs-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686499729
mkdir -p clr-build
pushd clr-build
